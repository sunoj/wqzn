...
exports.createPages = ({ graphql, actions }) => Promise.all([
    ...
    createPages.createShowcasePage({ graphql, actions }),
    createPages.createBrandPage({ graphql, actions }),
    createPages.createTagsPage({ actions }),
    createPages.createTagMatchPage({ graphql, actions })
])
